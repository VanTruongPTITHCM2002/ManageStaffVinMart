...
<body>
    ...
    font-size: 25px;
    color: orangered;
    font-family: FontAwesome">Thông tin của nhóm 24</h4>
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">                   
                            <div class="table-responsive">		
                             <ul>               						
								<li><h1>Nguyễn Văn Trường - N20DCCN161</h1></li>
								<li><h1>Đậu Văn Hoàng - N20DCCN017</h1></li>
								<li><h1>Nguyễn Nhật Quang - N19DCPT055</h1></li>
								</ul>		
                            </div>
                        </div>
                    </div>
            ...
            <footer class="footer text-center">
               Xin chào, tôi là Trường, đây là github của tôi
                <a href="https://github.com/VanTruongPTITHCM2002">link</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
