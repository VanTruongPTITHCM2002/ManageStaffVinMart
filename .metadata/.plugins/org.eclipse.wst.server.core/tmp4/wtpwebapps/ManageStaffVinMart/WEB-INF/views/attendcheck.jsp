...
<body>
    ...
    font-size: 25px;
    color: orangered;
    font-family: FontAwesome">Danh sách chấm công</h4>
                <div class="row">
            ...
            <!-- ============================================================== -->
            <span class="icon"><i class="fa fa-search"></i></span> <input onkeyup = "searchTable('search-chamcong','table-chamcong')"
						...
						<div class="card">						
							<div class="table-responsive">
								<table class="table" id = "table-chamcong">
									...
									<tbody>
									<c:forEach var = "p" items = "${ctcc}">
										<tr>											
											<td>${p.lichlamviec.manhanvien.maNV}</td>
											<td>${p.ngaycc}</td>
											<td>${p.giovao}</td>											
