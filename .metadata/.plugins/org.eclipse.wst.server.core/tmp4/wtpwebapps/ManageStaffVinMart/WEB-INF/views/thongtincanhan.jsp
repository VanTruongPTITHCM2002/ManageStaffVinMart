...
<body>
    ...
    font-size: 25px;
    color: orangered;
    font-family: FontAwesome">Thông tin cá nhân</h4>
                <div class="row">
            ...
            <script>
            var message = "${mess5}";
            if ( message === "Cập nhật nhân viên thành công") {
                swal({
                    title: "Thông báo",
                    text: message,
                    icon: "success",
            ...
            else if(message === "Ngày tháng năm sinh không hợp lệ"){
            	 swal({
                     title: "Thông báo",
                     text: message,
                     icon: "error",
		    ...
		    document.getElementById('email').value = email;
				...
				<div class="modal" id="inform1" onClick="stopCloseModal(event)">
					...
					<div class="col-lg-8 col-xlg-9" style = "margin-left: 200px">
						<div class="card">
							<div class="card-body">
								<form class="form-horizontal form-material mx-2" id = "form-update-staff" action = "update-inform.html" modelAttribute = "nvql" method = "POST">
									...
									<div class="form-group">
										<div class="col-sm-12">
											<button class="btn btn-success text-white" name = "btnupdate-employer">Cập nhật
												hồ sơ</button>											
										</div>
									</div>
								</form>
