    ...
    <div id="main-wrapper" data-navbarbg="skin6" data-theme="light" data-layout="vertical" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                 <div class="center">
            <form method = "post" action = "changepassword.html" class = "box" style = "background:cadetblue">
            <h1 style = "font-weight:bold">Đổi mật khẩu</h1>
            <div class="txt-field">
                    <span></span>
               ...
               <input type="submit" name = "change_pass" value = "Xác nhận">
            </form>
        </div>
         	<script>

		 var message = "${tin_nhan_pass}";
		    if (message === "Lỗi mật khẩu không trùng khớp" || message === "Sai mật khẩu") {
		        swal({
		            title: "Thông báo",
		            text: message,
		            icon: "error",
		    ...
		    else if (message === "Đổi mật khẩu thành công"){
		    	swal({
		            title: "Thông báo",
		            text: message,
		            icon: "success",
		            button: "OK",
		        	  ...
		        	  var currentURL = window.location.href;
		        	    var newURL = currentURL.replace("/user/changepassword.html", "/home.html");
