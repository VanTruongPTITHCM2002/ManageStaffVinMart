...
<body>
    ...
    font-size: 25px;
    color: orangered;
    font-family: FontAwesome">Danh sách lịch làm việc</h4>
                <div class="row">
			...
			<span class="icon"><i class="fa fa-search"></i></span> <input onkeyup = "searchTable('search_lichlamviec','table-lichlamviec')"
							type="search" id="search_lichlamviec" placeholder="Tìm kiếm lịch làm việc" style = "width:300px;margin-bottom:10px"/>
           	<script>
