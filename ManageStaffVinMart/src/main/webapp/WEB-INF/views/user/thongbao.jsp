...
<body>
    ...
    font-size: 25px;
    color: orangered;
    font-family: FontAwesome">Thông báo</h4>
				<div class="row">
			...
			<span class="icon"><i class="fa fa-search"></i></span> <input onkeyup = "searchTable('search-hopdonglaodong','table-hopdonglaodong')"
							type="search" id="search-hopdonglaodong" placeholder="Tìm kiếm thông tin hợp đồng" style = "width:300px;margin-bottom:10px"/>
				<!-- ============================================================== -->
				<!-- Start Page Content -->
				<!-- ============================================================== -->
					<div class="row">
						...
						<div class="card">
							...
							<div class="table-responsive" style = "height: 300px">
								<table class="table" id = "table-hopdonglaodong" >
									...
									<tbody>
									<c:forEach var = "p" items = "${user_tb}">
										<tr>											
											<td>${p.manhanvienthongbao.maNV}</td>											
											<td>${p.bangthongbao.ngayTB}</td>
											<td>${p.bangthongbao.noiDung}</td>
										</tr>
									</c:forEach>	
									</tbody>
								</table>
