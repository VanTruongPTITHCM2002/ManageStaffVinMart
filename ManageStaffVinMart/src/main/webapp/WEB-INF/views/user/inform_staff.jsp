...
<body>
					...
					<ul class="navbar-nav float-end">
						...
						<li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                                 <a class="dropdown-item" href="user/inform_staff.html" ><i class="fa fa-info-circle" style="font-size:14px"></i>
                                    Thông tin cá nhân</a>
    ...
    font-size: 25px;
    color: orangered;
    font-family: FontAwesome">Thông tin nhân viên</h4>
				<div class="row">
						...
						<div class="card">
							<div class="card-body">
								<form class="form-horizontal form-material mx-2" id = "form-update-staff" action = "pages-profile/add-staff.html" modelAttribute = "nhanviencuahang" method = "POST">
									...
									<div class="form-group">
										<div class="col-sm-12">
											<button class="btn btn-success text-white" name = "btnupdate-employee">Cập nhật
												hồ sơ</button>											
										</div>
									</div>
								</form>
